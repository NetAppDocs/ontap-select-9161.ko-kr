...
|===
. 새 관리 서버가 추가된 후 선택적으로 클릭할 수 있습니다. image:icon_kebab.gif["옵션"] 다음 중 하나를 선택하세요.
+
** 자격 증명 업데이트
** 자격 증명 확인
** 관리 서버 제거
...
YubiKey FIDO2 인증을 선택하는 경우, YubiKey Manager를 사용하여 YubiKey FIDO2 PIN을 설정하고 Windows의 경우 PuTTY-CAC(Common Access Card) 또는 MacOS의 경우 ssh-keygen을 사용하여 FIDO2 키를 생성하세요. 자세한 단계는 기술 보고서에 나와 있습니다. link:https://docs.netapp.com/us-en/ontap-technical-reports/security.html#multifactor-authentication["TR-4647: ONTAP 의 다중 인증"^] .
